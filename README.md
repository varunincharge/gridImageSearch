...
<img src='https://github.com/varunincharge/gridImageSearch/blob/master/GoogleImageSearch.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It took me a long time to get the endless scroll search functionality working correctly! It worked fine on the first search, but wasn't working right on subsequent searches. I had to tweak the EndlessScrollLisnter abastract class that was provided to us to get it working.
